...
tags:
  ...
  - digital-forensics
image:
  path: assets/attachments/cyber-cell-case-study.png
---
...
<img
  src="{{ '/assets/attachments/cyber-cell-field-project-certificate.jpg' | relative_url }}"
  alt="Field Project Certificate"
  style="max-width: 80%; height: auto; display: block; margin: 1.5rem auto;">
...
📄 **Download:** [Cyber Cell Field Project Questionnaire (PDF)]({{ '/assets/attachments/cyber-cell-questionnaire.pdf' | relative_url }})
...
## Key Cybercrime Trends Observed
