---
title: SyncKage – Secure Real-Time Google Drive Sync Android App
...
repo: https://github.com/Suryatejaeasari/SyncKage
image:
  path: assets/attachments/synckage.png
links:
  - label: GitHub
    icon: fab fa-github
    url: https://github.com/SuryatejaEasari/SyncKage
---
...
<div align="center">
  <img 
    src="https://github.com/user-attachments/assets/a890e090-fb9e-4aec-93af-225579e3c880"
    width="300"
    height="400"
    alt="Screenshot showing first view of the project interface"
  />
  &nbsp;&nbsp;&nbsp;
  <img 
    src="https://github.com/user-attachments/assets/96d0911f-8c31-4cd3-a320-7beb84adc05e"
    width="300"
    height="400"
    alt="Screenshot showing second view of the project interface"
  />
</div>
